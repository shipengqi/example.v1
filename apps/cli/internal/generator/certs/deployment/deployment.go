...
import (
	...
	"github.com/shipengqi/example.v1/apps/cli/pkg/kube"
	"github.com/shipengqi/example.v1/apps/cli/pkg/log"
	"github.com/shipengqi/example.v1/apps/cli/pkg/vault"
	"strings"
...
func New(ns, cdfns string, primary bool, k *kube.Config, v *vault.Config) (certs2.Generator, error) {
...
func (g *generator) GenAndDump(c *certs2.Certificate, resources string) (err error) {
