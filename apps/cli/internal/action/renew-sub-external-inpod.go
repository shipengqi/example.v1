...
import (
	...
	"github.com/shipengqi/example.v1/apps/cli/internal/generator/certs/deployment"
...
func (a *renewSubExternalInPod) Run() error {
	...
	return a.generator.GenAndDump(&certs2.Certificate{
