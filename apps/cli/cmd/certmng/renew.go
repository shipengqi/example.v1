...
func (o *renewOptions) combine(f *pflag.FlagSet, cfg *action2.Configuration) {
...
func newRenewCmd(cfg *action2.Configuration) *cobra.Command {
	o := &renewOptions{}
	c := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			r := action2.NewRenew(cfg)
			return action2.Execute(r)
		},
	}
